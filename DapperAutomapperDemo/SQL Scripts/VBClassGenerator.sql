...
I was not the original author of this. I updated it to support a couple of missing data types

Include System.ComponentModel.DataAnnotations in your project if you enable Annotations (@enableAnnotation)
...
set @table = 'TABLE_NAME'; -- SET THIS TO YOUR TABLE NAME
...
if (@enableAnnotation = 1)
	print '<Table("' + @table + '")>';
print 'Partial Public Class ' + @table;
open cursorPoco;
